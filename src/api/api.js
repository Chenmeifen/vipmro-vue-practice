...
export const findBusinessByPurchase = () => {
    return axios.get(`${base}inquiry/findBusinessByPurchase`)
};

export const getInquiryGoodsList = (queryParam) => {
    return axios.post(`${base}inquiry/goodsList`, qs.stringify(queryParam), headers);
};

export const curPurchaseBrand = () => {
    return axios.get(`${base}purchaseBrand/curPurchaseBrand`)
};

export const brandNameList = () => {
    return axios.get(`${base}brandRelation/brandNameList`)
};
